...
label_head = Label(root, text="FIR Portal",width=15,font=("Tahoma", 40,"bold"),fg ="#48929B", background='white',justify="center")
label_head.place(x=0,y=5)

label_0 = Label(root, text="SIGN-IN",width=23,font=("Tahoma", 20,"bold"),fg ="#F62459", background='white',justify="center")
label_0.place(x=50,y=250)

label_1 = Label(root, text="SSN",width=13,font=("Courier New", 16,"bold"),fg ="#F62459", background='white')
...
label_2 = Label(root, text="First Name",width=13,font=("Courier New", 16,"bold"),fg ="#F62459", background='white')
...
label_3 = Label(root, text="Last Name",width=13,font=("Courier New", 16,"bold"),fg ="#F62459", background='white')
...
label_8 = Label(root, text="Username",width=13,font=("Century Gothic", 16,"bold"),fg ="#F62459", background='white')
...
label_9 = Label(root, text="Password",width=13,font=("Century Gothic", 16,"bold"),fg ="#F62459", background='white')
...
b = Button(root, text='Submit',width=13,height=1,bg='#049372',fg='white', command=printtext,font=("Century Gothic", 16,"bold"),activebackground="#00ff00").place(x=146,y=650)
Button(root, text='Login',width=13,height=1,bg='#049372',fg='white', command=log,font=("Century Gothic", 16,"bold"),activebackground="#00ff00").place(x=146,y=700)
Button(root,text='Quit',width=13,height=1,bg='#D24D57',fg='white', command=dest,font=("Century Gothic", 16,"bold"),activebackground="#ff0000").place(x=146, y= 750)
root.mainloop()
