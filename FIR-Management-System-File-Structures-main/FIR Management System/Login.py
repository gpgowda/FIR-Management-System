...
label_head = Label(root, text="FIR Portal",width=15,font=("Tahoma", 40,"bold"),fg ="#E68364", background='white',justify="center")
label_head.place(x=0,y=5)

label_0 = Label(root, text="LOGIN",width=23,font=("Tahoma", 20,"bold"), background='white',fg ="black")
label_0.place(x=50,y=270)

label_1 = Label(root, text="Username",width=13,font=("Courier New", 16,"bold"), background='white')
...
label_2 = Label(root, text="Password",width=13,font=("Courier New", 16,"bold"), background='white')
...
b = Button(root, text='Login',width=13,height=1,bg='#afa394',fg='black',background="red",font=("Century Gothic", 16,"bold"), command=printtext).place(x=156,y=580)
Button(root, text='Quit',width=13,height=1,bg='#afa394',fg='black',background="green",font=("Century Gothic", 16,"bold"),command=dest).place(x=156,y=630)
Button(root, text='Sign-up',width=13,height=1,bg='#afa394',background="red",font=("Century Gothic", 16,"bold"),fg='black',command=sin).place(x=156,y=680)
root.mainloop()
